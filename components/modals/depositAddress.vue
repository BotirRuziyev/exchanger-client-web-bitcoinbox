                    ...
                    >
                      ...
                      <transition name="faded">
                        <div
                          ...
                          v-if="address && sellRoutesList[0]?.to?.xml === wallet?.currency?.xml && sellRoutesList[0].from && sellRoutesList[0].from.min > 0"
                        >
                          <p>min:</p>
                          <p>
                            {{ sellRoutesList[0].from.min }}
                            {{ sellRoutesList[0].from.symbol }}
                          </p>
                        </div>
                      </transition>
                      ...
                      <transition name="faded">
                        <div
                          class="deposit-modal__rate"
                          v-if="address && sellRoutesList[0]?.to?.xml === wallet?.currency?.xml && sellRoutesList[0].from && sellRoutesList[0].from.max > 0"
                        >
                          <p>max:</p>
                          <p>
                            {{ sellRoutesList[0].from.max }}
                            {{ sellRoutesList[0].from.symbol }}
                          </p>
                        </div>
                      </transition>
