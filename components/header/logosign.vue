    ...
    <transition v-if="!hideBtnLogin" name="faded">
      <div v-if="!info || !info.email" class="registration">
        <ul>
          <li>
            <button
              class="btn-round btn-round-transparent"
              @click="setReg(true)"
            >
              {{ $t("ui.header.reg") }}
            </button>
          ...
          <li>
            <button class="btn-round btn-round-white" @click="setLogin(true)">
              {{ $t("ui.header.sign") }}
            </button>
          </li>
        </ul>
      ...
      <div v-else class="user-bloc">
        <div class="user-bloc-date" @click="change(!user)">
          <div
            v-if="info && info.first_name && info.last_name"
            class="user-bloc-date-photo"
          >
