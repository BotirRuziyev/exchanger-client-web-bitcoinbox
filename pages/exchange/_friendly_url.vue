...
export default {
  ...
  async created() {
    this.val1 = this.$route?.query?.from;
    this.correctTo();
    ...
    const res = await this.$rest
      .api("GET:public/exchanger/route/get/one/by-friendlyURL", {
        friendlyURL: this.$route.params.friendly_url,
    ...
    if (res && res.success && res.data && res.data.route) {
      ...
      this.currentRoute = {
        ...res.data.route,
        seo: {
          title: localizeText(routeSeo.title, this.$i18n.locale),
          subtitle: localizeText(routeSeo.subtitle, this.$i18n.locale),
          h1: localizeText(routeSeo.h1 || routeSeo.title, this.$i18n.locale),
          h2: localizeText(routeSeo.h2 || routeSeo.subtitle, this.$i18n.locale),
          description: localizeText(routeSeo.description, this.$i18n.locale),
          instruction: localizeText(routeSeo.instruction, this.$i18n.locale),
        },
      };
      this.localLoad = true;
